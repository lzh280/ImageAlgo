...
void MainWindow::on_pushButton_openImg_clicked()
{
    auto fileContentReady = [=](const QString &fileName, const QByteArray &fileContent) {
        ...
        sourceImg.loadFromData(fileContent);
    ...
    QFileDialog::getOpenFileContent("Images (*.jpg *.png *bmp *.jpeg *.jfif)",  fileContentReady);
}
...
void MainWindow::on_toolButton_saveAsImg_clicked()
{
    ...
    buffer.close();
    QString filename = "Output_border.png";
...
void MainWindow::on_toolButton_saveAsSVG_clicked()
{
    ...
    svgPainter.end();
    buffer.close();
    QString filename = "Output_svg.svg";
